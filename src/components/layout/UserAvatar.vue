...
<template>
  <div
    class="relative isolate shrink-0 overflow-hidden rounded-full ring-1 ring-inset ring-glow-border-soft"
    :class="[sizeClass, normalizedSrc ? 'bg-glow-avatar-bg' : 'bg-glow-hover-surface']"
  >
    <img
      v-if="normalizedSrc"
      :src="normalizedSrc"
